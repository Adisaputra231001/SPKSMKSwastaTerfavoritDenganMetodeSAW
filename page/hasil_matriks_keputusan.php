...
/******akhir isi table perangkingan****/
    ...
    echo "<p>Jadi rekomendasi pemilihan SMK Swasta Terfavorit <i>$execute[namaBarang]</i> jatuh pada <i>$execute[namaSupplier]</i> dengan Nilai <b>".round($execute['hasil'],3)."</b></p>";
echo "</div>";
}else{
    echo "<p class='text-center'><b>Pilih SMK Swasta Terfavorit, untuk menampilkan hasil</b></p>";
}
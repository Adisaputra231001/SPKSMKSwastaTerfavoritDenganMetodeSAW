...
<form id="form" method="POST" action="./proses/prosestambah.php">
    ...
    <div class="panel-middle">
        <div class="group-input">
            <label for="supplier" >Nama Sekolah Swasta :</label>
            <input type="text" class="form-custom" required autocomplete="off" placeholder="Nama Sekolah Swasta" id="supplier" name="supplier">
        </div>
    </div>
